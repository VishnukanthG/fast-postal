    ...
    <div class="container">
        ...
        <div class="about-grids">
            <div class="about-grids-row1">
	                   ...
	                   <div id="abc">
							<center><h2>Update Location, Enter Item ID</h2></center>
                                        ...
                                        //$qr=mysqli_query($con,$q2);
                                                if($rows['status']==-1)  
                                                  echo '<script type="text/javascript"> alert("Item Not Picked Up Yet") </script>';
                                                    ...
                                                    {
                                                        echo '<script type="text/javascript"> alert("Location is already updated") </script>';    
                                                    }
                                                else if($rows['status']==2)
                                                    echo '<script type="text/javascript"> alert("This Item Has Been Successfully Delivered To The Desination") </script>';
                                    }
                                    else
                                    {
                                            echo '<script type="text/javascript"> alert("Sorry!!! item not destined to this city.") </script>';           
                                    }
                                }
