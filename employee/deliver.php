                                    ...
                                    if($rows=mysqli_fetch_array($query_run))
                                    {
                                                ...
                                                if($rows['status']==-1)  
                                                  echo '<script type="text/javascript"> alert("Item Not Picked Up Yet") </script>';
                                                    ...
                                                    echo '<script type="text/javascript"> alert("This Item has been already Delivered") </script>';
                                    }
                                    else
                                    {
                                            echo '<script type="text/javascript"> alert("Sorry item not reached the Destination.") </script>';           
                                    }
                                }
