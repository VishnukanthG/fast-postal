    ...
    <div class="container">
        ...
        <div class="about-grids">
            <div class="about-grids-row1">
	                   ...
	                   <div id="abc">
	<center><h2>Request Shippment</h2></center>
													...
													$query_run=mysqli_query($con,$query);
														if($query_run)
															...
															if($val=mysqli_fetch_array($query_run2))
																$to=$_SESSION['emml'];
																$sub='PicK Up Request';
																$msg="\n\nHi ".$_SESSION['username'].", your item pickup request has been added successfully.  ID:".$val[0].". Kindly keep it for future reference";
																$hed='from: no-reply';
